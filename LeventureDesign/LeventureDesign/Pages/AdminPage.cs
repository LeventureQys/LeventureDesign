...
namespace LeventureDesign
{
    ...
    public partial class AdminPage : Form
    {
        ...
        private void btn_QsManager_Click(object sender, EventArgs e)
        {
        ...
        private void btn_ScAnalyse_Click(object sender, EventArgs e)
        {
            AnalyseMain AnaInit = new AnalyseMain();
            AnaInit.Show();
        }
    }
}
