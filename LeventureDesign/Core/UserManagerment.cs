...
namespace LeventureDesign
{
    public class UserManagerMent
    {
        ...
        public DataGridView DataView_InitUsers(DataGridView dataGridView1,DataSet users)
        {
            try {
                ...
                dataGridView1.Columns[4].HeaderText = "权限等级";
                dataGridView1.Columns[5].HeaderText = "性别";
                dataGridView1.Columns[6].HeaderText = "电子邮箱";
                dataGridView1.Columns[7].HeaderText = "班级ID";
                dataGridView1.Columns[8].HeaderText = "是否激活";
